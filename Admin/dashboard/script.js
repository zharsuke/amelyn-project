...
document.querySelectorAll('.dashboard-ctn').forEach(ctn => {
    ctn.addEventListener('mouseover', function(e) {
        ctn.firstElementChild.style.scale = '1.2'
    })
    ctn.addEventListener('mouseout', function(e) {
        ctn.firstElementChild.style.scale = '1'
    })
})